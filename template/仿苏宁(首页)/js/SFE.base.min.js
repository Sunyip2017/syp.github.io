function hrefLink(a) {
    if (navigator.userAgent.indexOf("Firefox") > 0)
        ...
        if (b.href = a, document.body.appendChild(b), /msie/i.test(navigator.userAgent.toLowerCase()))
            b.click();
        else {
...
SFE.base = function(a) {
    ...
    var f = "https:" == document.location.protocol ? "https" : "http", g = !!window.ActiveXObject, h = g && !window.XMLHttpRequest, i = function(a) {
        var b = /^(\w*)(pre)(.*)(\.cnsuning\.com)$/, c = /^(\w*)(sit)(.*)(\.cnsuning\.com)$/;
        return b.test(a) ? "pre" : c.test(a) ? "sit" : "prd"
    }, j = "";
    "https" == f && (j = ' src="https://imgssl.suning.com/images/ShoppingArea/Common/blankbg.gif" ');
    var k = function(a) {
        var b;
        return(b = document.cookie.match(RegExp("(^| )" + a + "=([^;]*)(;|$)"))) ? decodeURIComponent(b[2].replace(/\+/g, "%20")) : null
    }, l = function() {
        if (void 0 == sn.passportLogon || null == sn.passportLogon) {
            var a = /^(\w*)(pre)(\w*)(.cnsuning.com)$/, b = /^(\w*)(sit)(\w*)(.cnsuning.com)$/, c = /^(\w*)(dev)(\w*)(.cnsuning.com)$/, d = document.location.hostname;
            sn.passportLogon = "https://passport.suning.com/ids/login", a.test(d) ? sn.passportLogon = "https://passportpre.cnsuning.com/ids/login" : b.test(d) ? sn.passportLogon = "https://passportsit.cnsuning.com/ids/login" : c.test(d) && (sn.passportLogon = "https://passportdev.cnsuning.com/ids/login")
        }
        return sn.passportLogon
    }, m = function() {
        if (void 0 == sn.passportLogoff || null == sn.passportLogoff) {
            var a = /^(\w*)(pre)(\w*)(.cnsuning.com)$/, b = /^(\w*)(sit)(\w*)(.cnsuning.com)$/, c = /^(\w*)(dev)(\w*)(.cnsuning.com)$/, d = document.location.hostname;
            sn.passportLogoff = "https://passport.suning.com/ids/logout", a.test(d) ? sn.passportLogoff = "https://passportpre.cnsuning.com/ids/logout" : b.test(d) ? sn.passportLogoff = "https://passportsit.cnsuning.com/ids/logout" : c.test(d) && (sn.passportLogoff = "https://passportdev.cnsuning.com/ids/logout")
        }
        return sn.passportLogoff
    }, n = function() {
        var a = new Date;
        a.setTime(a.getTime() - 1e4), document.cookie = "logonStatus=a; expires=" + a.toGMTString();
        var b = l(), c = m(), d = c + "?service=" + encodeURIComponent(b + "?method=GET&loginTheme=b2c");
        window.location = d, SFE.base.miniCartNum()
    }, o = function() {
        if (!L()) {
            var a = "", b = "", c = l();
            if (void 0 == sn.sslDomain || null == sn.sslDomain) {
                var d = /^(\w*)(pre)(\w*)(.cnsuning.com)$/, e = /^(\w*)(sit)(\w*)(.cnsuning.com)$/, f = /^(\w*)(dev)(\w*)(.cnsuning.com)$/, g = document.location.hostname;
            ...
            if (-1 != window.location.href.indexOf("&MyURL")) {
                var h = window.location.href.substring(window.location.href.indexOf("&MyURL") + 7, window.location.href.length);
        ...
        var a = "";
        if (void 0 == sn.sslDomain || null == sn.sslDomain) {
            var b = /^(\w*)(pre)(\w*)(.cnsuning.com)$/, c = /^(\w*)(sit)(\w*)(.cnsuning.com)$/, d = /^(\w*)(dev)(\w*)(.cnsuning.com)$/, e = document.location.hostname;
            sn.sslDomain = "ssl.suning.com", b.test(e) ? sn.sslDomain = "sslpre.cnsuning.com" : c.test(e) ? sn.sslDomain = "sslsit.cnsuning.com" : d.test(e) && (sn.sslDomain = "ssldev.cnsuning.com")
        }
        ...
        var b = {contents: null, align: "right", vertical: "middle", zIndex: 7500, css: {}, id: null, ieFixed: !0}, c = a.browser.msie ? parseInt(a.browser.version) : !1;
        if (arguments.length < 1 || !(arguments[0]instanceof Object))
            return a.error("ECode.floatBar: 鍙傛暟蹇呴』涓篔SON瀵硅薄");
        a.extend(b, arguments[0]);
        var d = {position: "fixed", top: "-9999em", left: "-9999em"};
        c && 6 >= c && (d.position = "absolute"), a('<div class="ECode-floatBar"></div>').css(d).appendTo("body");
        var e = a("body").find(".ECode-floatBar:last");
        e.append(b.contents);
        var f = e.width(), g = e.height(), h = {zIndex: b.zIndex};
        ...
        var i = function() {
            var c = a(document).scrollTop(), d = a(window).height();
            a(document).width();
            switch (b.vertical) {
                case"top":
                    e.stop().animate({top: c});
                    break;
                case"bottom":
                    var f = d + c - g;
                    ...
                    e.css({marginTop: 0}).stop().animate({top: f});
                    break;
                case"middle":
                    e.stop().animate({top: d / 2 + c - g / 2})
                }
        };
    ...
    if ("https" == f)
        var y = new Date, z = y.getFullYear() + "" + y.getMonth() + y.getDate(), A = {topNav: "https://" + w + "imgssl.suning.com/images/nav.html?v=" + z, allSort: "https://" + w + "imgssl.suning.com/images/cate.html?v=" + z, mainNav: "https://" + w + "imgssl.suning.com/images/chn.html?v=" + z, threeData: "https://" + w + "imgssl.suning.com/images/menuData.html?v=" + z};
    else if ("http" == f)
        var A = {topNav: "http://lib" + v + "suning.com/header/nav-topnav.jsonp", allSort: "http://lib" + v + "suning.com/header/cate-allSort.jsonp", mainNav: "http://lib" + v + "suning.com/header/chn-mainNav.jsonp", threeData: "http://lib" + v + "suning.com/header/menuData-threeSortShow.jsonp"};
    if (!g) {
        var B, C = (window.location + "", new RegExp(/Pad/) || new RegExp(/pad/));
        B = C.exec(navigator.userAgent) ? !0 : !1
    }
    var D = function() {
        ...
        c.hover(function() {
            ...
            a(".ng-sn-site-nav").css("left", -b), SFE.search.searchIptBlur()
        ...
        var b = (a(".ng-site-nav-box"), a(".ng-sort-list-box"), a(".ng-nav-index").find(".ng-nav"), a(".ng-nav-right-txtact")), c = k("idsLoginUserIdLastTime");
        (null == c || "" == c) && a.ajax({url: A.mainNav, method: "get", dataType: "jsonp", jsonpCallback: "mainNav", cache: !0, success: function(a) {
                b.html(a)
            }})
    }, K = function() {
        ...
        if (L()) {
            var c = a("#waitEvaluation"), d = a("#waitDeliveryCounts"), e = a("#waitPayCounts"), g = !1, h = !1;
            a(".myorder-handle").mouseenter(function() {
                if (!g) {
                    k("custno");
                    a.ajax({url: f + "://review" + v + "suning.com/ajax/getpendingCount/waitEvaluation_callback.do", method: "get", dataType: "jsonp", cache: !0, jsonpCallback: "waitEvaluation_callback", success: function(a) {
                            var d = parseInt(a.pendingOrderCount);
                            c.html(b(d)), g = !0
                        }})
                }
                h || a.ajax({url: f + "://member" + v + "suning.com/webapp/wcs/stores/servlet/SNOrdersCountCmd", method: "get", dataType: "jsonp", success: function(a) {
        ...
        function b() {
            var a, b, c, d, e = 0;
            i.find("li").live({mouseenter: function(c) {
        ...
        function c() {
            j.animate({width: "0px"}, 100, function() {
                i.find("li").removeClass("hover"), a(this).removeClass("ng-sort-detail-border")
            }), m.mouseleave()
        }
        function d() {
            q || a.ajax({url: A.threeData, method: "get", dataType: "jsonp", jsonpCallback: "threeSortShow", cache: !0, success: function(a) {
                    p = a, q = !0
                }})
        }
        function e(b) {
            var c = a(this).scrollTop(), d = i.offset().top;
            sn.isHome && (c > d ? j.animate({top: c - d + 38}, 100) : j.animate({top: 38}, 100));
            var e = "", f = "";
            if (r.html(" "), s.html(" "), q && "undefined" != typeof p && "undefined" != typeof p[b]) {
                var g = k("cityId") || "9173", h = p[b];
                ...
                if ("undefined" != typeof h.sub)
                    for (var l = 0; l < h.sub.length; l++) {
                        var u = h.sub[l], v = 0 == l ? "lastdl" : "";
                        if (f += "<dl class='" + v + "'>", "undefined" != typeof u.t) {
                            var w = u.t.title, x = u.t.link, y = u.t.trickPoint, z = u.t.style, m = null == x.match(/cityId=.*&/gi) ? "" : "&";
                        ...
                        if ("undefined" != typeof u.s && u.s.length > 0) {
                            ...
                            for (var A = 0; A < u.s.length; A++) {
                                var B = u.s[A], C = B.title, D = B.link, E = B.trickPoint, F = B.style, m = null == D.match(/cityId=.*&/gi) ? "" : "&";
        ...
        var f, g, h, i = a(".ng-sort-list-box"), j = a(".ng-sort-detail"), l = a("a.ng-all-hook"), m = a(".ng-sort"), n = a(".ng-nav-index");
        b(), i.find("li").live({mouseenter: function() {
                var b = a(this);
                clearTimeout(f), f = setTimeout(function() {
                    b.addClass("hover").siblings("li").removeClass("hover");
                    var a = b.index(), c = b.attr("maxCol");
        ...
        i.hover(function() {
            ...
            i.slideDown(function() {
                sn.isHome && n.animate({width: "90px"}, 200)
            })
        }, function() {
            sn.isHome ? n.animate({width: "0px"}, 200, function() {
                i.slideUp()
            }) : i.slideUp()
        }), m.click(function(a) {
            a.stopPropagation()
        ...
        var p, q = !1, r = a(".sort-chanel"), s = a(".cate-list");
        if (sn.isHome)
            d();
        else {
            var g;
        ...
        function b() {
            ...
            0 == j ? k = n.offset().top + p + b : "", q > 660 && !h && (sn.isHome || sn.hasTopFixed) && (i > k ? c() : d(), j = i > k ? !0 : !1), k >= i && (d(), j = !1), 0 == j ? "" : 1
        }
        function c() {
        ...
        function e() {
            0 == r.find("ul.sort-list").length && a.ajax({url: A.allSort, method: "get", dataType: "jsonp", jsonpCallback: "allSort", cache: !0, success: function(a) {
                    r.prepend(a)
                }})
        }
        function f() {
        ...
        var i, j, k, l, m, n = a(".ng-sort"), o = a(".ng-fix-bar"), p = n.height(), q = a(window).height(), r = (a(".ng-bottom-fixed-pub"), a(".ng-bottom-fixed-sidebar"), a(".ng-sort-list-box"));
        ...
        var s = a(".ng-bottom-fixed"), t = s.find(".ng-slide-box-code"), u = s.find("a.code-btn"), v = s.find("a.ng-btn"), w = a(".ng-slide-box-life"), x = s.find("a.ng-close");
        v.click(function() {
            s.find(".ng-slide-box").slideUp().siblings("a.ng-btn").removeClass("ng-btn-hover")
        });
        var y = u.attr("link");
        500 > q && u.attr({href: y, target: "_blank"}), sn.isHome ? "" : a("#ng-mob-link").attr("href", y), u.click(function() {
            t.is(":visible") ? g() : f()
        ...
        function c() {
            var b = a(".ng-new-pro"), c = b.find(".footer-egg-btn"), d = b.find(".footer-egg-con"), f = '<div id="foot_canvas"></div><link href="http://sale.suning.com/images/advertise/helloworld/css/footer-egg-css.css?var=06" rel="stylesheet" /><script src="http://sale.suning.com/images/advertise/helloworld/js/footer-egg-js.js?var=06" type="text/javascript"></script>', g = a(window).width(), h = b.find(".ng-new-pro-con").width(), i = (g - h) / 2;
...
//                var d = a("#footer-dom-01").val(), f = a("#footer-dom-02").val();
...
//            a(window).width() > 990 && !e && sn.isHome && c()
        ...
        var b = a("#searchKeywords"), c = a.trim(b.val());
        if ("" == c)
            b.focus();
        else {
            ...
            var f = sn.searchDomain.replace("emall/", "") + encodeURIComponent(e(c)), g = k("cityId") || "9173";
            ...
            try {
                var h = a(".g-ac-store").find("em").eq(0).text(), i = c, j = "YT_" + i + "_" + h + "_" + search_da_djc_index, l = a('<a href="###" name="' + j + '"></a>')[0];
    ...
    return{d: k, toolBarEvent: R, setSearchCity: u, replaceCityParam: c, replaceCityPlaceHolder: d, registerurl: p, logonurl: o, allSort: N, fixEvent: O, miniCartReload: H, miniCartNum: I, isLogin: L, getCity: q, logoff: n, footerLazyLoad: P, floatBar: t, onSubmitSearch: T}
}(jQuery), $(function() {
    SFE.base.toolBarEvent(),  SFE.base.allSort(), SFE.base.fixEvent(), SFE.base.footerLazyLoad(), $("a[name^=public0_],input[name^=public0_]").live("click", function() {
        "undefined" != typeof sa && sa.click.sendDatasIndex(this)
    }), $(".ng-bottom-fixed a.ng-btn").on("click", function() {
        "undefined" != typeof sa && sa.click.sendDatasIndex(this)
    })
});
//eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('0();c 0(){2 a="l",5=1,7=".";2 d=8.9.b.n();e(d.f(4,1)!=\'g\'||d.h!=i){$("j").k();3 m}3 6}',24,24,'authentication||var|return||count|true|dot|window|location||host|function||if|substr|s|length|16|html|remove|com|false|toString'.split('|'),0,{}))